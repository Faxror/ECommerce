...
builder.Services.AddAplicationRegistration(builder.Configuration);

#region
// Add services to the container.
builder.Services.AddScoped<GetAddressByIdQuaryHandler>();
builder.Services.AddScoped<GetAddressQuaryHandler>();
builder.Services.AddScoped<CreateAddressCommandHandler>();
builder.Services.AddScoped<RemoveAdressCommandHandler>();
builder.Services.AddScoped<UpdateAddressCommandHandler>();

builder.Services.AddScoped<GetOrderDetailByIdQuaryHandler>();
builder.Services.AddScoped<GetOrderDetailQuaryHandler>();
